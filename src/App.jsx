...
function VideoPlayer({ videoId, url, label, onClose }) {
  ...
  useEffect(() => {
    ...
    videoRef.current.play().catch(e => console.warn('autoplay blocked:', e.message))
  }, [url])
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 500, background: '#000', display: 'flex', flexDirection: 'column', animation: 'fadeIn 0.3s ease' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#000' }}>
        <video ref={videoRef} controls loop playsInline style={{ maxWidth: '100%', maxHeight: '100%', width: '100%' }} />
      </div>
